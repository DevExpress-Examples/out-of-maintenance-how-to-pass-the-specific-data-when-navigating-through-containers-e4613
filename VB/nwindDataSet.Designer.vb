...
Namespace ParamNavigation
	...
	End Class
End Namespace
Namespace ParamNavigation.nwindDataSetTableAdapters
	...
	Public Partial Class TableAdapterManager
		...
		Public Property Connection() As Global.System.Data.IDbConnection
			Get
				If (Not Me._connection Is Nothing) Then
					Return Me._connection
				End If
				If ((Not Me._employeesTableAdapter Is Nothing) AndAlso (Not Me._employeesTableAdapter.Connection Is Nothing)) Then
		...
		Public Overridable Function UpdateAll(ByVal dataSet As nwindDataSet) As Integer
			...
			If (dataSet.HasChanges() = False) Then
				Return 0
			End If
			If ((Not Me._employeesTableAdapter Is Nothing) AndAlso (Me.MatchTableAdapterConnection(Me._employeesTableAdapter.Connection) = False)) Then
